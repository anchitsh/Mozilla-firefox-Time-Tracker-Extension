...
function lasttime() {
    ...
    var titletime_inminutes = parseInt(localStorage.getItem(title));
    var addedtime = titletime_inminutes + totalminutes;

    localStorage.setItem("asstest", titletime_inminutes);
    localStorage.setItem("asstest2", addedtime);

    if(titletime_inminutes!=0 || titletime_inminutes!=null || isNaN(parseFloat(titletime_inminutes))==false ) {
        var addedtime = titletime_inminutes + totalminutes;
        localStorage.setItem("test1", totalminutes);
        localStorage.setItem("test2", titletime_inminutes);
        updatetop(title, totalminutes, titletime_inminutes);
        localStorage.setItem(title, addedtime);

    }
    else if(isNaN(parseFloat(titletime_inminutes))==true||titletime_inminutes==null||titletime_inminutes==0) {
        localStorage.setItem(title, totaltime);
        updatetopthree(title, totalminutes);
        localStorage.setItem("test3", totalminutes);
    }
}
